...
% This function uses MOSEK to construct and solve the adaptive robust 
...
% Generate SDP constraint matrix
[constraint_matrix,B,b,Atilde,Btilde,Ctilde] = constraints(N,sys);
...
sx = mod.variable('sx', Domain.inRange(-10.,3.)); 
